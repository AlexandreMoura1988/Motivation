...
class Mock {
    ...
    private val ALL = MotivationConstante.PHRASEFILTER.ALL
    private val HAPPY = MotivationConstante.PHRASEFILTER.HAPPY
    private val MORNING = MotivationConstante.PHRASEFILTER.MORNING
